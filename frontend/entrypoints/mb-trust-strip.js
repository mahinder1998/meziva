...
class MBTrustSlider extends HTMLElement {
  constructor() {
    super();
    this.slider = null;
    this._inited = false;
  ...
  _init() {
    ...
    const spacing = Number(this.dataset.spacingMobile || 12);
...
if (!customElements.get(TAG)) {
  customElements.define(TAG, MBTrustSlider);
}
