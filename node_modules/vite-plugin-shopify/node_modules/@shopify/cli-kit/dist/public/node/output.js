 ...
 */
export function outputResult(content) {
 ...
 */
export function outputInfo(content, logger = consoleWarn) {
 ...
 * @param logger - The logging function to use to output to the user.
 */
export function outputSuccess(content, logger = consoleWarn) {
 ...
 * @param logger - The logging function to use to output to the user.
 */
export function outputCompleted(content, logger = consoleWarn) {
